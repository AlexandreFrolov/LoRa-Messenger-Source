 ...
 *   - "EByte LoRa E22" (Renzo Mischianti)
 *   - "ESPAsyncWebServer" (ESP32Async fork, совместимый с ESP32 core 3.x)
 *   - "AsyncTCP" (ESP32Async fork)
 *   - "ArduinoJson" (v6 или v7)
 *   - "Adafruit NeoPixel"
 * ==========================================================================*/
...
#define NODE_ADDL      0x01     // уникальный адрес узла в сети (0x01, 0x02, 0x03 ...)
